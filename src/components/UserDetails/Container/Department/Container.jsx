...
import AddDepartment from './AddDepartment'
  function DepartmentContainer({ userData }) {
    const {id} = useParams();
...
const {openModal,closeModal}=useModal();
    ...
    const getData = async (curr) => {
      try {
        ...
        const result = await api.get(`/department/get-manager/${id}?limit=${LISTING_LIMIT}&&offset=${offset}&search=${appliedFilters.search}&department=${appliedFilters.department ? appliedFilters.department.value.id : ""}&is_approval=${appliedFilters.is_approval ? appliedFilters.is_approval.value : ""}`);
