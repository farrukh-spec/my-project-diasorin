...
const Sidebar = () => {
  ...
  return (
    ...
    <>
      ...
      <motion.aside
        className={`fixed md:static top-0 left-0 z-50 w-52 h-screen border border-gray-300 bg-white 
  flex flex-col  border-r-gray-300 flex-shrink-0 text-gray-700 overflow-hidden `}
      ...
      >
        ...
        <div className='flex items-center justify-between h-[90px] w-full border-b border-gray-300 p-4 '>
          ...
          <button onClick={() => setIsOpen(false)} className='rounded-full p-2 hover:bg-green-100 ' >

            <ArrowLeftFromLine className='h-6 w-6  text-gray-700 cursor-pointer' /> {/* lucide react icon */}
          </button>
        </div>
        ...
        <div className='w-full p-2    border-t border-gray-300  '>
          <button className='w-full rounded-2xl   text-gray-700 p-2  hover:text-white  hover:bg-gray-900 '
